...
({
    ...
    sendMessage: function(component, event, helper) {
        ...
        component.find("FSLMAX_LayoutEditor").message(msg);
    },
    handleMessage: function(component, message, helper) {
        var params = JSON.parse(JSON.stringify(message._params));
        var payload  = params.payload;
        var entityType = payload.entityType, recordId = payload.recordId, objectName = payload.objectName, sourceObject = payload.sourceObject, headerObject = payload.headerObject, isHeaderObjectField = payload.isHeaderObjectField;
        ...
        if (isLookupConfig || isFieldMapping || isValueMapping || isExpression ||
                isVisibilityCriteria || isConfigurationFilter) {
            //Launch the lookup editor.
