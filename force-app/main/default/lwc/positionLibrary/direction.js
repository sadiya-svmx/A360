...
export function checkFlipPossibility (parent, element, target, leftAsBoundary) {
    ...
    // When used in console app, console's viewport is not window, 
    // but a scrollable div, then popup can be cut off easily.
    // scrollable parent => if any parent element set overflow-y:auto, 
    // then inner element won't popup, unless use position:fix.
