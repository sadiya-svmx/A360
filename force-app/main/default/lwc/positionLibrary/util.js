...
export function normalizePosition (
    ...
    // or 2. When element isn't align with target's width, 
    // and target's parent has overflow-x:hidden setting.
    const isFixed =
        overlay.isInside ||
        (!alignWidth &&
    ...
    // To always allow positioning from the left 
    // we set right to auto so position library can do its work.
