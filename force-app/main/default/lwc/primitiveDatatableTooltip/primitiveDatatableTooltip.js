...
export default class PrimitiveDatatableTooltip extends LightningElement {
    @api header = '';
    @api content = [];
    @api size = 'medium';
    ...
    @track _showErrorButton = false;
    @track _offset = ZERO_OFFSET;
