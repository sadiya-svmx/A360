import labelLoadingActions from '@salesforce/label/c.Label_LoadingActions';
...
export default class PrimitiveCellActions extends LightningElement {
    ...
    @track _isLoadingActions;
    @track _actions = [];
    @track _menuAlignment = DEFAULT_MENU_ALIGNMENT;
    @track _internalTabIndex = false;
    ...
    set rowActions (value) {
        this._rowActions = Array.isArray(value) ? [...value] : [];
    }
