...
// Looks like mocks are failing if this is exported
// via a direct export from selector-shared, so we need to
 ...
 * This will reflect in removing aria-selected
 * attribute in the cell td or th (if it was previously added).
 *
 * Note: This change is volatile, and will be reset (lost) in the next index regeneration.
 *
 * @param {Object} state - the state of the datatable
